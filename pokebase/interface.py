...
from pokebase.api import get_data, get_sprite
...
#클래스
class APIResource(object): #__dir__함수를 통해 lookup 가능한 attributes 확인 가능
    ...
    def _load(self):
        ...
        data = get_data(self.endpoint, self.id_, force_lookup=self.__force_lookup) #실질적인 데이터 fetch
